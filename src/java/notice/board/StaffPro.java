...
public class StaffPro extends HttpServlet {
...
byte[] buffer=null;
int bytesRead=0;
 String query="(select post,fname from staff1 where uname=? and pass=?)";
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        se.printStackTrace();
            ...
            out.println(" <img src='StaffImage' alt=\"picture\" style=\"width:100%\">");
